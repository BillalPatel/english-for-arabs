...
export function Footer() {
  return (
    <footer className="mt-20 text-center bg-neutral-100 text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
      ...
      <div className="py-10 mx-6 text-center md:text-left">
        <div className="grid gap-8 grid-1 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="">
            ...
            <p>Some sort of lovely text goes here.</p>
          </div>
          {/* <!-- Products section --> */}
          <div className="">
